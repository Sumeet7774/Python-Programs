...
def add():
    ...
    print('Your full name is: ',num1,num2)
...
label1 = tk.Label(root, text = 'Enter your first name: ')   #we are creating a label here
entry1 = tk.Entry(root,textvariable = var1)                 #we are taking value from the textbox1 by using entry function

label2 = tk.Label(root, text = 'Enter your surname: ')      #we are creating a label here
